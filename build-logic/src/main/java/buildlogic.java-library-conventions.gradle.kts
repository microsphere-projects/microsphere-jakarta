    ...
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name = project.name
                description = project.description
                url = "https://github.com/microsphere-projects/microsphere-jakarta"
                ...
                scm {
                    url = "git@github.com/microsphere-projects/microsphere-jakarta.git"
                    connection = "scm:git:git@github.com/microsphere-projects/microsphere-jakarta.git"
                    developerConnection = "scm:git:ssh://git@github.com/microsphere-projects/microsphere-jakarta.git"
                }
            }
